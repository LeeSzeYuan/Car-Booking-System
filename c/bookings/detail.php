    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col">
                            ...
                            <table class="table">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row["v_type"] ?> - <?php echo $row["v_id"] ?></td>
                                    </tr>
                ...
                <a href="delete.php?id=<?php echo $row["v_id"]; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure to delete this booking');"><i class="fa fa-trash"></i> DELETE</a>
