<?php
    ...
    $sql = "SELECT * FROM tb_booking 
            ...
            WHERE tb_user.user_id = '".$_SESSION['user_id']."'";

    $parameter = "";
        
    if (isset($_GET["brand"])){
        $sql .= " AND tb_brand.b_id = ?";
        $brand = $_GET["brand"];
    ...
    if (isset($_GET["name"])){
        ...
        $sql .= " AND (tb_vehicle.v_type LIKE '%".$name."%' or tb_vehicle.v_id LIKE '%".$name."%' 
    ...
    <div class="container-fluid">
        <div class="row align-items-start">
            ...
            <div class="col-md-3 col-xl-3 mb-4">
                <a href="create.php" class="btn btn-primary">New Bookings</a>&nbsp&nbsp&nbsp
                                ...
                                <tbody>
                                    ...
                                    ?>
                                                    <tr>
                                                        ...
                                                        <td><a href="vehicle.php?id=<?php echo $row["v_id"] ?>"><?php echo $row["v_type"] ?></a></td>
                                                        ...
                                                        <?php
                                                            if ($row["b_status"] == 1){
                                                                ...
                                                                echo '<button class="btn btn-warning btn-sm">'.$row["s_desc"].'</button>';
                                                            }
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="update.php?id=<?php echo $row["book_id"]; ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>&nbsp
                                                            <a href="delete.php?id=<?php echo $row["book_id"]; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure to delete this booking');"><i class="fa fa-trash"></i></a>
                                                        </td>
