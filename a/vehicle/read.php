...
<body>
    <div class="container-fluid">
        <div class="row align-items-start">
            <div class="col-md-8 col-xl-8 mb-12"><h2 class="text-dark mb-4">VEHICLE LIST</h2></div>

            <div class="col-md-3 col-xl-3 mb-4">
                <a href="create.php" class="btn btn-primary">New Vehicle</a>&nbsp&nbsp&nbsp
                                ...
                                <tbody>
                                    ...
                                    ?>
                                                    <tr>
                                                        ...
                                                        <td><img class="rounded-circle mr-2" width="30" height="30" src="<?php echo $row["v_img_path"] ?>"><?php echo $row["v_id"] ?></td>
                                                        ...
                                                        <td>
                                                            <a href="detail.php?id=<?php echo $row["v_id"]; ?>" class="btn btn-info btn-sm"><i class="fa fa-book"></i></a>&nbsp
                                                            <a href="update.php?id=<?php echo $row["v_id"]; ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>&nbsp
                                                            <a href="delete.php?id=<?php echo $row["v_id"]; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure to delete this brand');"><i class="fa fa-trash"></i></a>
                                                        </td>
