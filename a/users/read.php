<?php
    ...
    $sql = "SELECT * FROM tb_user WHERE usertype = 'C'";
    ...
    <div class="container-fluid">
        <div class="row align-items-start">
            ...
            <div class="col-md-3 col-xl-3 mb-4">
                <a href="reada.php" class="btn btn-primary">View Admin Users</a>&nbsp&nbsp&nbsp
                                    ...
                                    ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="delete.php?id=<?php echo $row["user_id"]; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure to delete this user');"><i class="fa fa-trash"></i></a>
                                                        </td>
